...
for ($i=$awali;$i<=$akhiri;$i++) {
	...
	$iprof= um412_isicombo5("select id,title from master_data where (jenis='symposium' or jenis='workshop') and status<>2 order by kode ","gprof[$i]","id","title","","","hitungHrgGroup($i)");
